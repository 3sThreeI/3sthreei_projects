...
import EmailForm from "@/components/customComponent/formContact/formEmail"
                    ...
                    <div className={style.bodyGrid}>
                        <div className={style.mainContent}>
                            <div className={style.Metadata}>
                                ...
                                <EmailForm
                                    eyebrow={t.body.formSubscribe.eyebrow}
                                    title={t.body.formSubscribe.title}
                                    description={t.body.formSubscribe.description}
                                    label={t.body.formSubscribe.label}
                                    placeholder={t.body.formSubscribe.placeholder}
                                    button={t.body.formSubscribe.button}
                                    note={t.body.formSubscribe.note}
                                />
                            </div>
                        </div>
